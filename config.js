...
module.exports = {
      ...
      SESSION_ID: process.env.SESSION_ID || "QUEEN-AI;;;PuffyEnclosed", //enter your session id here
      OWNER_NUMBER: process.env.OWNER_NUMBER || "923393950000", //Owner whatsapp number here
      OWNER_NAME: process.env.OWNER_NAME || pukathub", //Queen-AI Owner Name here
